...
# MAM IT IS GIVING ERROR OF CV2 ATTRIBUTE  IT WAS LAST DAY FOR SUBMISSION  SO I AM SUBMITTING...........  
...
def drawBox(img,bbox):
    x,y,w,h = int(bbox[1]),int(bbox[1]),int(bbox[2]),int(bbox[3])
    cv2.rectangle(img,x,y),((x+w),(y+w),(225,0,225),3,1)
    cv2.putText (img,"Tracking",(75,90),cv2.FONT_HERSHEY_SIMPLEX,0.7,(0,255,0),2)
